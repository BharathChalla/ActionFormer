...
# Omnivore
## Training
python train.py configs/error_dataset_custom_feature.yaml --backbone 3dresnet --division_type recordings --feat_folder /home/rxp190007/DATA/features/3dresnet --num_frames 30 --output reproduce
python train.py configs/error_dataset_custom_feature.yaml --backbone 3dresnet --division_type person --feat_folder /home/rxp190007/DATA/features/3dresnet --num_frames 30 --output reproduce
python train.py configs/error_dataset_custom_feature.yaml --backbone 3dresnet --division_type environment --feat_folder /home/rxp190007/DATA/features/3dresnet --num_frames 30 --output reproduce
